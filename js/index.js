...
const aboutMe =
    "Welcome to my portfolio! I'm a CS student at George Mason University. My interests lie in crafting code across diverse domains, including robotics and contributing to open source projects.";

const projects =
    "-> I have worked extensively with creating script based and graphical mods for games like" +
...
document.getElementById("projects-link").addEventListener("mouseup", () => {
    ...
    document.getElementsByClassName("fs-4")[0].style.display = "flex";
});
...
document.getElementById("about-me-link").addEventListener("mouseup", () => {
    ...
    document.getElementsByClassName("fs-4")[0].style.display = "none";
});
